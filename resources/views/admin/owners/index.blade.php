                            ...
                            <div class="lg:w-2/3 w-full mx-auto overflow-auto">
                                ...
                                <tbody>
                                    ...
                                    <td class="border-t-2 border-gray-200 px-4 py-3">
                                        <button onclick="location.href='{{ route('admin.owners.edit', ['owner' => $owner->id]) }}'" class="text-white bg-indigo-500 border-0 py-2 px-8 focus:outline-none hover:bg-indigo-600 rounded flex ml-auto">編集</button>
                                    </td>
                                    </tr>
                                    @endforeach
                                </tbody>
