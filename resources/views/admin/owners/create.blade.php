                    ...
                    <section class="text-gray-600 body-font relative">
                        <div class="container px-5 py-4 mx-auto">
                            <div class="flex flex-col text-center w-full mb-12">
                                <h2 class="sm:text-3xl text-2xl font-medium title-font text-gray-900">オーナー登録</h2>
                            </div>
                            <div class="lg:w-1/2 md:w-2/3 mx-auto">
                                <div class="-m-2">
                                    ...
                                    <div class="p-2 w-full flex justify-around mt-12">
                                        <button onclick="location.href='{{ route('admin.owners.index') }}'" class="text-white bg-gray-400 border-0 py-2 px-12 focus:outline-none hover:bg-gray-500 rounded text-lg">戻る</button>
                                        <button class="text-white bg-yellow-500 border-0 py-2 px-12 focus:outline-none hover:bg-yellow-600 rounded text-lg">登録</button>
                                    </div>
                                </div>
                            </div>
                        </div>
