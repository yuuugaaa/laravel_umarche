                            ...
                            <form method="post" action="{{ route('owner.products.store') }}">
                                ...
                                <div class="-m-2">
                                    ...
                                    <div class="p-2 w-4/5 mx-auto">
                                        ...
                                        <div class="mr-4"><input type="radio" name="is_selling" value="1" checked class="mr-2">販売中</div>
                                        <div class="mr-4"><input type="radio" name="is_selling" value="0" class="mr-2">停止中</div>
                                        </div>
                                    </div>
